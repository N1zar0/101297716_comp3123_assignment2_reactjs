...
export const getEmployeeById = async (employeeId) => {
  try {
    ...
    return response.data.employee; // Adjust this based on your backend response structure
  } catch (error) {
    throw error.response.data;
  }
};
...
export const deleteEmployee = async (employeeId) => {
  try {
    ...
    if (response.status === 204) {
      return 'Employee deleted successfully'; // Return any success message or appropriate data
    }
